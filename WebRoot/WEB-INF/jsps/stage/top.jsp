...
<<<<<<< HEAD
		<span class="top">注册账号<i></i> </span> 
		<input id="regist_username" class="username input" name="username" type="text" placeholder="账号">
		<span id="usernameMsg" class="eMsg"></span> 
		<input id="regist_password" class="password input" name="password" type="password" placeholder="密码">
		<span id="passwordMsg" class="eMsg"></span> 
		<input id="regist_repassword" class="username input" name="repassword" type="password" placeholder="确认密码">
		<span id="repasswordMsg" class="eMsg"></span> 
		<input id="regist_name" class="name input" name="name" type="text" placeholder="昵称">
		<span id="nameMsg" class="eMsg"></span> 
		<input id="regist_email" class="email input" name="email" type="text" placeholder="邮箱">
		<span id="emailMsg" class="eMsg"></span>
=======
