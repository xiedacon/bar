...
public class VerifyCodeUtil {
	...
	public static String draw(OutputStream out) throws IOException {
		VerifyCodeUtil codeUtil = new VerifyCodeUtil();
		codeUtil.draw0(out);
		return codeUtil.getVerifyCode();
	}
	...
	public VerifyCodeUtil draw0(OutputStream out) throws IOException {
